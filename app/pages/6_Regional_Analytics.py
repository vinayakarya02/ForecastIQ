...
if not country.empty:
    ...
    fig.update_layout(
        margin=dict(l=0, r=0, t=10, b=0), geo=dict(showframe=False, showcoastlines=False)
    )
...
if not mgr.empty:
    charts.show(
        charts.bar(
            mgr.sort_values("revenue"),
            "revenue",
            "region_manager",
            "Revenue by region manager",
            orientation="h",
