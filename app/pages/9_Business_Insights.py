...
_ACCENT = {
    "growth": "#16a34a", "risk": "#dc2626", "regional": "#2563eb",
    "seasonality": "#f59e0b", "opportunity": "#7c3aed", "returns": "#db2777",
}
...
for _, row in df.iterrows():
    ...
    if row["metric"] is not None:
        try:
            metric = f'<span style="color:#94a3b8;font-size:.8rem"> · {float(row["metric"]):,.1f}</span>'
